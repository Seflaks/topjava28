...
public class SpringMain {
    public static void main(String[] args) {
        ...
        try (ConfigurableApplicationContext appCtx = new ClassPathXmlApplicationContext("spring/spring-app.xml")) {
            ...
            adminUserController.create(new User(null, "Ivan", "petovivan@mail.ru", "password", Role.ADMIN));
            ...
            adminUserController.create(new User(null, "Ivan", "ivan@mail.ru", "password", Role.ADMIN));
